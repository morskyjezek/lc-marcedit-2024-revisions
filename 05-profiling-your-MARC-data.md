...
MarcEdit provides multiple reporting options and tools to help you to understand
the contents of a MaRC file, particularly since individual files typically 
contain records for multiple items. This process can be described as a data profile
of the MaRC file you are working with. To profile MaRC data, MarcEdit can create
various data reports. Reports are located under the Reports tab.

### Reports for Data Overviews
...
To run a Find Records by Type Reports:
